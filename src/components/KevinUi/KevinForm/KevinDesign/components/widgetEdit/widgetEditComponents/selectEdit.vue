    ...
    <div class="s_e_a_left">
      ...
      >
        ...
        <el-row>
          ...
          <el-col :span="12" v-if="editParams.filterable">
            <el-form-item label="是否可创建条目" prop="allowCreate">
              <el-select v-model="editParams.allowCreate">
                <el-option label="是" :value="true"></el-option>
                <el-option label="否" :value="false"></el-option>
              </el-select>
            </el-form-item>
        ...
        <el-divider>选择框数据源配置</el-divider>
        <el-row>
          <el-col :span="12">
            <el-form-item
              label="获取远程数据脚本"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item
              label="下拉框出现/隐藏时触发"
              prop="events.visibleChange"
            >
              <el-input v-model="editParams.events.visibleChange" readonly>
                <el-button
                  slot="append"
                  size="small"
                  @click="e_editSelectEvents('visibleChange')"
                  >编辑</el-button
                >
              </el-input>
            </el-form-item>
          ...
          <el-col :span="12" v-if="editParams.multiple">
            <el-form-item
              label="多选模式下移除tag时触发"
              prop="events.removeTag"
            >
              <el-input v-model="editParams.events.removeTag" readonly>
                <el-button
                  slot="append"
                  size="small"
                  @click="e_editSelectEvents('removeTag')"
                  >编辑</el-button
                >
              </el-input>
            </el-form-item>
