<template>
    <div style="width: 100%;height: 100%;">
                    ...
                    <el-col :span="24">
                        <el-table ref="tableColumns" class="tableColumns" :data="editParams.tableColumns"
                            ...
                            <el-table-column prop="prop" label="字段名(prop)" align="center">
                                <template slot-scope="scope">
                                    <el-input :disabled="scope.row.type == 'action' || scope.row.type == 'index'"
                                        v-model="scope.row.prop" @blur="e_confirmColumnsProp(scope.row)"></el-input>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column prop="prop" label="列宽" align="center" width="220">
                                <template slot-scope="scope">
                                    <el-input-number v-model="scope.row.width" :min="5" :max="300"></el-input-number>
                                </template>
                            </el-table-column>
        ...
        <component v-if="showComponent" ref="component" :is="conponentsName" @close="showComponent = false"
            @save="e_saveVmoduleEdit"></component>
    ...
    methods: {
            ...
            new Sortable(tbody, {
                ...
                onEnd: function (obj) {
                    const list = JSON.parse(
                        JSON.stringify(that.editParams.tableColumns),
                    );
        ...
        rowTableActions() {
            ...
            new Sortable(tbody, {
                ...
                onEnd: function (obj) {
                    const list = JSON.parse(
                        JSON.stringify(that.editParams.tableActions),
                    );
