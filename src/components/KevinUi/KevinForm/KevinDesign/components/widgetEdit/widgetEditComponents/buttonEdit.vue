<template>
  <widgetEditContainer>
    ...
    >
      <el-col :span="24">
        <el-form-item label="效果展示" prop="title">
          <el-button
            ...
            @click="$message.info('效果展示')"
            >{{ editParams.title }}</el-button
          >
        </el-form-item>
      </el-col>
      <el-col :span="24">
      ...
      <el-col :span="24">
        <el-form-item label="按钮权限" prop="perm">
          <el-input v-model="editParams.perm">
            <el-button slot="append" @click="e_editPerm">选择权限</el-button>
          </el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
      ...
      <el-col :span="24">
        <el-form-item
          ...
          prop="events"
          :rules="[
            { required: true, message: '请编辑按钮事件', trigger: 'change' },
          ]"
        >
          <el-input v-model="editParams.events" readonly>
            <el-button slot="append" size="small" @click="e_editButtonEvents"
              >编辑</el-button
            >
          </el-input>
        </el-form-item>
