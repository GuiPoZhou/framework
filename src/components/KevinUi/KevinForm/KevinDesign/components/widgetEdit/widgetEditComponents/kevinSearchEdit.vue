<template>
    <widgetEditContainer>
        <el-form slot="wecLeft" :model="editParams" ref="editParams" label-width="130px" class="demo-ruleForm">
            ...
            <el-col :span="24">
                <el-form-item label="搜索按钮所占列数" prop="searchAreaCol">
                    <el-input-number v-model="editParams.searchAreaCol" :min="4" :max="24"></el-input-number>
                </el-form-item>
            </el-col>
            <el-col :span="24">
            ...
            <el-col :span="24">
                <el-form-item label="搜索按钮事件" prop="events.search"
                    ...
                    <el-input v-model="editParams.events.search" readonly>
                        <el-button slot="append" size="small" @click="e_editButtonEvents('search')">编辑</el-button>
                    </el-input>

                </el-form-item>
            </el-col>
            <el-col :span="24">
                <el-form-item label="重置按钮事件" prop="events.repeat"
                    :rules="[{ required: true, message: '请编辑重置按钮事件', trigger: 'change' }]">
                    <el-input v-model="editParams.events.repeat" readonly>
                        <el-button slot="append" size="small" @click="e_editButtonEvents('repeat')">编辑</el-button>
                    </el-input>
