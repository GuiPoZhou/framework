        ...
        <div class="b_b_c_left">
          ...
          >
            ...
            <el-col
              :span="12"
              v-if="
                slotParams.type == 'datetimerange' ||
                slotParams.type == 'daterange' ||
                slotParams.type == 'monthrange'
              "
            >
              <el-form-item label="defaultTime" prop="defaultTime">
                <el-input v-model="slotParams.defaultTime" readonly>
                  <el-button slot="append" @click="e_editdefaultTime"
                    >编辑</el-button
                  >
                </el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="PickerOptionsCode" prop="pickerOptions">
                <el-input v-model="slotParams.pickerOptions" readonly>
