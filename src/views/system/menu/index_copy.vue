<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column prop="perms" label="权限标识" align="center" width="220">
                <template slot-scope="scope">
        ...
        <div v-if="showMenuLog">
            <el-dialog :title="title" :visible.sync="open" width="60%" append-to-body>
              ...
              <span slot="label">
                <el-tooltip content="访问的路由地址，如：`user`，如外网地址需内链访问则以`http(s)://`开头,微前端不要修改填充的路径，以防无法正确访问" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                路由地址
              </span>
