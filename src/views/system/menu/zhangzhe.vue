        ...
        <div class="a-c-top" v-show="showSearch">
            <el-form :model="queryParams" ref="queryForm" :inline="true"  label-width="100px">
                ...
                <el-form-item label="状态" prop="status">
                    <el-select v-model="queryParams.status" placeholder="菜单状态" clearable size="small" @change="handleQuery" style="width: 240px;">
                        <el-option
                ...
                <el-form-item label="系统类型" prop="sysType">
                    <el-select v-model="queryParams.sysType" placeholder="系统类型" clearable size="small" @change="handleQuery" style="width: 240px;">
                        <el-option
...
export default {
    ...
    created() {
        ...
        this.getDicts("sys_type").then(response => {
