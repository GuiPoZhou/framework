<template>
  <div class="app-container" style="background-color: #fff; margin: 10px">
    ...
    >
      ...
      <el-table-column prop="menuType" label="类型" align="center">
        <template slot-scope="scope">
          ...
          <el-tag effect="dark" type="success" v-if="scope.row.menuType == 'C'"
            >菜单</el-tag
          >
          <el-tag effect="dark" type="warning" v-if="scope.row.menuType == 'F'"
            >权限</el-tag
          >
        </template>
      </el-table-column>
      ...
      <el-table-column prop="visible" label="显示状态" align="center">
        <template slot-scope="scope">
          <dict-tag
      ...
      <el-dialog :title="title" :visible.sync="open" width="60%" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          <el-row>
            ...
            <el-col :span="12" v-if="form.menuType != 'F' && sysType == 3">
              <el-form-item label="菜单图标" prop="icon">
                <div class="menuIcon-content">
                  <el-button
                    style="margin-right: 0.8rem"
                    type="primary"
                    size="mini"
                    @click="e_getUploadIcon"
                    >上传</el-button
                  >
                  <el-image
                    :src="form.icon"
                    style="width: 100px; height: 100px; cuirsor: pointer"
                    fit="fill"
            ...
            <el-col :span="12" v-if="form.menuType == 'C'">
              <el-form-item label="选择路由表">
                <el-button type="primary" size="small" @click="e_selMicroRouter"
                  >选择</el-button
                >
              </el-form-item>
            </el-col>
            ...
            <el-col :span="12">
              <el-form-item label="低码Key" prop="lowCodeKey">
                <el-input
                  v-model="form.lowCodeKey"
                  placeholder="请输入低码 key"
                />
              </el-form-item>
            </el-col>
            <el-col :span="12" v-if="form.menuType != 'F' && sysType == 3">
              <el-form-item>
                ...
                <el-radio-group v-model="form.shortcutStatus">
            ...
            <el-col :span="24" v-if="form.menuType == 'C'">
              <el-form-item prop="path">
                ...
                <el-input type="textarea" v-model="form.path" placeholder="请输入路由地址" />
              </el-form-item>
            </el-col>
            <el-col :span="12" v-if="form.menuType == 'C'">
              <el-form-item label="组件路径" prop="component">
                <el-input
                  ...
                  placeholder="请输入组件路径(微前端子应用无视该输入框)"
                />
              </el-form-item>
            </el-col>
        ...
        <el-divider v-if="form.menuType == 'C'" content-position="left"
          >权限列表</el-divider
        >
        <el-table
          ...
          style="width: 100%"
        >
          <el-table-column prop="menuName" align="center" label="权限名称">
            <template slot-scope="scope">
              <el-input
    ...
    <MicroAppRouter
      ref="MicroAppRouter"
      v-if="showMicroAppRouter"
      @close="e_closeMicroAppRouter"
    ...
    <uploadIco
      ...
      v-if="showuploadIco"
      @save="e_saveMenuIcon"
      @close="showuploadIco = false"
    />
    <!-- 手动新增权限 -->
    <addPermFrame
      ref="addPermFrame"
      v-if="showaddPermFrame"
      @reload="e_reload"
      @close="showaddPermFrame = false"
    />
  </div>
</template>
...
import uploadIco from "./dialog/uploadIco.vue";
import addPermFrame from "./dialog/addPermFrame.vue";
export default {
  name: "MenuManage",
  ...
  methods: {
     ...
     */
    e_addPerm(row) {
      if (row.path.match("mic")) {
        this.showAddPerm = true;
        this.$nextTick(() => {
          this.$refs.AddPerm.init(JSON.parse(JSON.stringify(row)));
        });
      } else {
        this.showaddPermFrame = true;
        this.$nextTick(() => {
          this.$refs.addPermFrame.init(row);
        });
      }
    },
    /**
