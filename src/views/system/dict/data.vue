<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <!-- <el-col :span="1.5">
        <el-button type="success" size="mini" :disabled="single" @click="handleUpdate"
      ...
      <el-col :span="1.5">
        <el-button type="warning" size="mini" @click="handleClose"
          >关闭</el-button
        >
      </el-col>
      <right-toolbar
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.dictCode != undefined) {
            ...
            this.form.pDictCode = this.pDictCode;
